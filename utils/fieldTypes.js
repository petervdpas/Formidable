...
export const latexSpecific = Object.freeze([
  "latexUseFenced", // switch: use fenced raw block
...
export const fieldTypes = {
  ...
  latex: {
    ...
    parseValue: parsers.parseLatexField,
    applyValue: appliers.applyLatexField,
  },
};
