...
export default {
  ...
  "standard.data": "Gegevens",
  "menu.data.import": "CSV importeren...",
  "menu.data.export": "CSV exporteren...",
  ...
  "toast.git.discarded.changes.in": "Wijzigingen in {0} verworpen.",
  ...
  "toast.git.autosync.noTracking":
    "Geen tracking branch ingesteld — auto-sync overgeslagen.",
  "toast.git.autosync.localChanges":
    "Lokale wijzigingen gedetecteerd — auto-sync overgeslagen.",
  ...
  "modal.settings.gigot.baseUrl": "GiGot Basis-URL",
  "modal.settings.gigot.repoName": "GiGot Repository",
  "modal.settings.gigot.token": "GiGot Abonnementstoken",
  "modal.settings.gigot.test": "Verbinding testen",
  "modal.settings.gigot.test.running": "Bezig met testen…",
  "modal.settings.gigot.test.ok": "Verbonden",
  "modal.settings.gigot.test.fail": "Verbinding mislukt",
  ...
  "modal.gigot.destinations.add": "+ Mirror toevoegen",
  "modal.gigot.destinations.url": "Mirror-URL (bv. https://github.com/owner/repo.git)",
  "modal.gigot.destinations.credential": "Credential-naam (kluisitem met de PAT)",
  "modal.gigot.destinations.enabled": "Ingeschakeld (automatisch pushen bij elke commit)",
  "modal.gigot.destinations.save": "Opslaan",
  "modal.gigot.destinations.cancel": "Annuleren",
  "modal.gigot.destinations.saving": "Opslaan…",
  "modal.gigot.destinations.delete": "Verwijderen",
  "modal.gigot.destinations.confirm": "Bevestig verwijderen",
  "modal.gigot.destinations.deleting": "Verwijderen…",
  ...
  // ── CSV Import ──────────────────────────────
  "modal.csv.import.title": "CSV importeren",
  "csv.choose.file": "Kies CSV-bestand...",
  "csv.no.file": "Geen bestand geselecteerd",
  "csv.delimiter": "Scheidingsteken",
  "csv.delimiter.comma": "Komma (,)",
  "csv.delimiter.semicolon": "Puntkomma (;)",
  "csv.delimiter.tab": "Tab",
  "csv.delimiter.pipe": "Pipe (|)",
  "csv.template": "Sjabloon",
  "csv.column": "CSV-kolom",
  "csv.field": "Sjabloonveld",
  "csv.preview": "Voorbeeld",
  "csv.transform": "Transformatie",
  "csv.transformed": "Getransformeerd",
  "csv.transform.none": "Geen",
  "csv.transform.trim": "Inkorten",
  "csv.transform.lowercase": "Kleine letters",
  "csv.transform.uppercase": "Hoofdletters",
  "csv.transform.capitalize": "Eerste hoofdletter",
  "csv.transform.trimlower": "Inkorten + Kleine",
  "csv.transform.trimupper": "Inkorten + Hoofd",
  "csv.transform.trimcap": "Inkorten + Eerste hoofd",
  "csv.transform.firstn": "Eerste N tekens",
  "csv.transform.lastn": "Laatste N tekens",
  ...
  "csv.skip": "overslaan",
  "csv.filename.field": "Bestandsnaam afleiden uit",
  "csv.auto.filename": "Bestandsnaam automatisch genereren",
  "csv.import": "Importeren",
