...
export default {
  ...
  "status.template.create.new.error": "Error creating new template.",
  ...
  "status.template.select.failed": "Failed to select template {0} with error: {1}.",
  ...
  "status.metadata.new.ready": "New metadata entry ready.",
